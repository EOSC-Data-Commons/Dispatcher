#!/usr/bin/env python3
"""
Main test script for VREGalaxy class.
This script loads the RO-Crate metadata, creates a VREGalaxy instance,
...
# Add the app directory to Python path to import VREGalaxy
...
def main():
    """Main test function."""
    print("Testing VREGalaxy with RO-Crate")
    print("=" * 50)
